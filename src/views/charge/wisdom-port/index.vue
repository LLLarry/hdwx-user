<template>
  <div class="wisdom-port d-flex flex-column">
    <!-- 顶部区域 -->
    <Header
      :code="code"
      :areaname="areaname"
...
export default {
  ...
  methods: {
    ...
    async checkPortStatus(portList) {
      ...
      const portItem = portList.find(
        item => this.selectPort === Number(item.port)
      )
      if (portItem) {
