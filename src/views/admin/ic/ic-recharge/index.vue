<template>
  <div class="ic-recharge margin-2 bg-gray">
    <div class="ic-item bg-white rounded-md overflow-hidden margin-bottom-4">
      <section
      ...
      >
        <div class="total-money text-center">
          ...
          <div class="text-white">&yen; <span class="money">0.00</span></div>
        </div>
          ...
          <li class="flex-1 text-center border-box border-right-1">
            <div>
              ...
              <div class="text-white">
                &yen; <span class="money">0.00</span>
              </div>
            </div>
          </li>
        ...
        <van-icon
          ...
          size=".55rem"
          @click="$router.push('/admin/walletdetail/1')"
        />
      </section>
      ...
      <section class="padding-bottom-2">
        <hd-recharge />
        <p class="text-a text-center text-size-sm margin-top-2">
          查看充值消费记录
        </p>
      </section>
    </div>
